...
import id.lazday.streaming.HomeActivity;
import id.lazday.streaming.LoginActivity;
...
//                            Log.e("_logVideoId",videos.get(position).getVideo_id());
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.instagram.com/edwinsyafriana/"));
